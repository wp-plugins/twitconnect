...
STOP:   
Install the SPIURL plugin before installing or ugrading this plugin.
...
- Integration with SPIURL (locally cached Twitter profile images).
  This will improve performance on your blog.
