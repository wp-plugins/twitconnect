...
<?php endif; ?>        
        ...
        <tr>
          ...
          <td>
            <table>
            <tr><td><input type="radio" name="twc_profile_images_chk" <?php echo $twc_profile_images_chk1 ?> value="spiurl" /> Twit Connect Image Service (<a href="http://www.voiceoftech.com/swhitley/?page_id=869" target="_blank">Please Donate</a>*)<br/> 
		  ...
		  <br/>%%username%% will be replaced with the user's Twitter name.<br/>
            ...
            <tr><td>
            <br/><strong>* Twit Connect Image Service</strong> - <a href="http://www.voiceoftech.com/swhitley/?page_id=869" target="_blank">DONATE NOW</a> - We will serve Twitter avatar images for you, but there is 
            a cost to store and serve these images.  Please donate <em>at least</em> $5 to keep the service running. 
                 <br/><br/><strong>** Self-Hosted</strong> - Required for very high-traffic sites (unless you make a substantial donation to the Twit Connect Image Service).<br/>
            </td></tr>
            </table>
          </td>
        </tr>
